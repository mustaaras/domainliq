    ...
    return (
        <div className="min-h-screen bg-[#050505] text-white p-8">
            <div className="max-w-4xl mx-auto prose prose-invert">
                ...
                <p className="text-gray-400 mb-8">Common questions about buying and selling on DomainLiq</p>

                <div className="space-y-8">
                    {/* General */}
                    <section>
                        <h2 className="text-2xl font-bold text-amber-500 mb-4">General</h2>

                        <div className="mb-6">
                            <h3 className="text-xl font-semibold mb-2">What is DomainLiq?</h3>
                    ...
                    {/* Buying & Escrow */}
                    <section>
                        <h2 className="text-2xl font-bold text-green-500 mb-4">Buying & Escrow</h2>
                        ...
                        <div className="mb-6">
                            ...
                            <ol className="list-decimal pl-6 text-gray-300 mt-2">
                    ...
                    {/* Selling */}
                    <section>
                        <h2 className="text-2xl font-bold text-blue-500 mb-4">Selling</h2>
                    ...
                    {/* Account & Privacy */}
                    <section>
                        <h2 className="text-2xl font-bold text-purple-500 mb-4">Account & Privacy</h2>
                ...
                <div className="mt-12 pt-8 border-t border-white/10 text-center">
                    <p className="text-gray-400">
                        Still have questions? <Link href="/contact" className="text-amber-500 hover:text-amber-400">Contact Us</Link>
                    </p>
                </div>
            </div>
        </div>
