        ...
        <div className="min-h-screen dark:bg-[#050505] bg-gray-50 dark:text-white text-gray-900 p-8">
            <div className="max-w-4xl mx-auto prose dark:prose-invert">
                ...
                <div className="dark:bg-green-500/10 bg-green-50 border dark:border-green-500/30 border-green-300 rounded-lg p-6 my-6">
                    <p className="font-bold dark:text-green-400 text-green-700 mb-2">Our Privacy Promise:</p>
                ...
                <p className="dark:text-gray-300 text-gray-700 mb-4">We use your information ONLY to:</p>
                <ul className="list-disc pl-6 dark:text-gray-300 text-gray-700 mb-4">
                ...
                <p className="dark:text-gray-300 text-gray-700 mb-4">Your information is shared in these limited ways:</p>
                <ul className="list-disc pl-6 dark:text-gray-300 text-gray-700 mb-4">
                ...
                <p className="dark:text-gray-300 text-gray-700 mb-4">We use minimal cookies for:</p>
                <ul className="list-disc pl-6 dark:text-gray-300 text-gray-700 mb-4">
                ...
                <p className="dark:text-gray-300 text-gray-700 mb-4">We protect your data through:</p>
                <ul className="list-disc pl-6 dark:text-gray-300 text-gray-700 mb-4">
                ...
                <p className="dark:text-gray-300 text-gray-700 mb-4">You have the right to:</p>
                <ul className="list-disc pl-6 dark:text-gray-300 text-gray-700 mb-4">
